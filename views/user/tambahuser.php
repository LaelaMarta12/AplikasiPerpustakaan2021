            ...
            <div class="card shadow mb-4">
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        <br>
                        <form action="model/user/prosestambahuser.php" method="POST">
                            <table class="table">
                                <tr>
                                    <td>nama pegawai</td>
                                    <td>:</td>
                                ...
                                <tr>
                                    <td>username</td>
                                    <td>:</td>
                                    <td><input type="text"  class="form-control" name="username" id="username"></input></td>
                                </tr>
                                <tr>
                                    <td>password</td>
                                    <td>:</td>
                                    <td><input class="form-control" name="password" id="password"></input></td>
                                </tr>
                                <tr>
                                    <td>jabatan</td>
                                    <td>:</td>
